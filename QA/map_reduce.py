...
question_prompt = PromptTemplate.from_template(
    template = """Use the following piece of context to answer the question at the end. If you do not know the answer, just say you do not know and do not makeup and answer.
    {context}
    Question:{question}
    Helpful answer:"""
)
...
QA_chain = RetrievalQA.from_chain_type(
    ...
    chain_type_kwargs = {"question_prompt": question_prompt ,
